...
import zzk.study.java.core.nio.FilesDemo;
...
public class JavaReadFileFromResourcesTest {

    @Test
    public void whenReadWithBufferedReader_thenCorrect() throws IOException {
        final String expected_value = "Hello, world!";
        System.out.println("current path:" + FilesDemo.getCurrentPath().toString());
        final BufferedReader reader = new BufferedReader(new FileReader("src/test/resources/io/readfile/fileTest.txt"));
    ...
    public void getResource() throws IOException {
        ...
        File file = new File(classLoader.getResource("io/readfile/fileTest.txt").getFile());
    ...
    public void getResourceAsStream() throws IOException {
        ...
        Class clazz = JavaReadFileFromResourcesTest.class;
        InputStream inputStream = clazz.getResourceAsStream("/io/readfile/fileTest.txt");
        String data = readFromInputStream(inputStream);
...
//        assertThat(data.trim(), CoreMatchers.containsString(expectedData));
    ...
    public void whenReadUTFEncodedFile_thenCorrect() throws IOException {
        ...
        final BufferedReader reader = new BufferedReader(new InputStreamReader(new FileInputStream("src/test/resources/io/readfile/fileTestUtf8.txt"), "UTF-8"));
        final String currentLine = reader.readLine();
        reader.close();
    ...
    private File getResourceFile(final String fileName) {
        ...
        if(url == null) throw new IllegalArgumentException(fileName + " is not found 1");
