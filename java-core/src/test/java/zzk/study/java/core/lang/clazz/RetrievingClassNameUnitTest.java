...
public class RetrievingClassNameUnitTest {
    ...
    public void givenRetrievingClassName_whenGetName_thenCanonicalName() {
        assertEquals("zzk.study.java.core.lang.clazz.RetrievingClassName", RetrievingClassName.class.getName());
    }

    @Test
    public void givenRetrievingClassName_whenGetTypeName_thenCanonicalName() {
        assertEquals("zzk.study.java.core.lang.clazz.RetrievingClassName", RetrievingClassName.class.getTypeName());
    }

    @Test
    public void givenRetrievingClassName_whenGetCanonicalName_thenCanonicalName() {
        assertEquals("zzk.study.java.core.lang.clazz.RetrievingClassName", RetrievingClassName.class.getCanonicalName());
    }
