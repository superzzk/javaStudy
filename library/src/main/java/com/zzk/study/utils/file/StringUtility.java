package com.zzk.study.utils.file;
...
public class StringUtility {
     ...
     *
     * @param array The array to convert into a map
     ...
     * @param startsWith The String to match.
     ...
     * is returned.
     *
     * @param prependChar  The char to prepend
     * @param targetLength The targetLength
     * @param initialInt   The initial Integer
     ...
     * @param prependChar   The char to prepend
     * @param targetLength  The targetLength
     * @param initialString The initiatlString
