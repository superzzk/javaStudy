...
/**
 * stub: we need to provide a dummy behavior of the class
 * mock: we would like to know if some method of the dependent object was called with specified arguments
 * spy: Spies provide the ability to wrap an existing object.
