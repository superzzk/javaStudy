package com.zzk.study.library.camel;
...
public class FileProcessorIntegrationTest {
    ...
    private void verifyFolderContent() {
        ...
        Awaitility.await().atMost(DURATION_MILIS, TimeUnit.MILLISECONDS).until(() -> {
            assertThat(destinationFile1).exists();
            assertThat(destinationFile2).exists();
        });
    }
}