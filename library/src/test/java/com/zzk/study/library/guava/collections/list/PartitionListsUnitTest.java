...
public class PartitionListsUnitTest {
    ...
    @Test
    public final void java8_groupBy() {
        final List<Integer> intList = Lists.newArrayList(1, 2, 3, 4, 5, 6, 7, 8);
    ...
    // java8 partitionBy
    @Test
    public final void java8_partitionBy() {
        final List<Integer> intList = Lists.newArrayList(1, 2, 3, 4, 5, 6, 7, 8);
    ...
    public final void givenList_whenSplittingBySeparator_thenCorrect() {
        ...
        final int[] indexes = Stream.of(IntStream.of(-1), IntStream.range(0, intList.size()).filter(i -> intList.get(i) == 0), IntStream.of(intList.size()))
