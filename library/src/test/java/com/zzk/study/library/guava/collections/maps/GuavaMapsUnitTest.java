...
public class GuavaMapsUnitTest {
    ...
    @Test
    public void sorted_map_builder() {
        final ImmutableSortedMap<String, Integer> salary = new ImmutableSortedMap.Builder<String, Integer>(Ordering.natural())
                .put("John", 1000).put("Jane", 1500).put("Adam", 2000).put("Tom", 2000).build();
    ...
    @Test
    public void user_index_to_group() {
