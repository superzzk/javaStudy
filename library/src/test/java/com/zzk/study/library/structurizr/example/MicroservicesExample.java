package com.zzk.study.library.structurizr.example;

import com.structurizr.Workspace;
import com.structurizr.api.StructurizrClient;
import com.structurizr.model.*;
import com.structurizr.view.*;
import com.zzk.study.library.structurizr.Utils;
...
public class MicroservicesExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(Utils.getC4StringForXuecheng(views.getDynamicViews().stream().findFirst().get()));
    }
